<main class="_formulaire">
  <form method="post" id="formulaire" name="formulaire" action="<?php echo URL . 'creation/recrutementCreation'; ?>">
	...
	<input id="recrutement" name="recrutement" type="text" title="JJ-MM-AAAA" value="" placeholder="JJ-MM-AAAA" pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}" minlength="10" maxlength="10" required/>
